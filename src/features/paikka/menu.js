const MENU_ITEMS = [
  {
    ...
    description: 'Smoked whole chickens, chopped and dressed in herbes de provence and basil and olive oil. Mostly breast. Layered with roasted cabbage mostarda, apple and celery, colby cheese.',
  ...
  },
  {
    ...
    description: 'Smoked whole chickens, chopped and dressed in herbes de provence and basil and olive oil. Mostly breast. Layered with roasted cabbage mostarda, apple and celery. Dairy-free option served without cheese.',
    presalePriceCents: 1400,
    regularPriceCents: 1600,
  ...
  },
  {
    ...
    description: 'Kabocha, acorn, and hubbard style squash, roasted and left to marinate overnight in sage, olive oil, vinegar, and cured sweet pepper. With the addition of romesco, malabar spinach, gruyere.',
  ...
  },
  {
    ...
    description: 'Kabocha, acorn, and hubbard style squash, roasted and left to marinate overnight in sage, olive oil, vinegar, and cured sweet pepper. With the addition of romesco, malabar spinach. Dairy-free option served without gruyere.',
    presalePriceCents: 1300,
    regularPriceCents: 1500,
