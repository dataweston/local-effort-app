                    ...
                    >
                      ...
                      {canEdit && onEditRecipe && onDeleteRecipe && (
                        <div className="flex gap-2 mt-3 pt-3 border-t border-[#66D3E7]/30">
                          <button
                            onClick={() => {
                              // For now, we'll show a simple prompt. You can enhance this with a proper editor dialog.
                              const newName = prompt('Edit recipe name:', meal.name);
                              if (newName && newName !== meal.name) {
                                onEditRecipe(section.key as MealType, code, {
                                  ...meal,
                                  name: newName,
                                });
                              }
