      ...
      try {
        ...
        if (linkRes.ok) {
          ...
          if (linkData?.url) {
            ...
            notifyToast('Redirecting to secure checkoutGÇª', { type: 'success' });
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                      ...
                      >
                        {discountState.status === 'checking' ? 'CheckingGÇª' : 'Apply'}
                      </Button>
                    </div>
                      ...
                      {requiresPayment ? (
                        <>
                          {!cardReady && !cardError && !paymentsError && (
                            <p className="text-sm text-gray-500">
                              {paymentsLoading
                                ? 'Loading secure payment formGÇª'
                                : 'Preparing secure payment formGÇª'}
                            </p>
                          )}
                ...
                <CardContent className="px-5 py-4">
                  <form className="space-y-4" onSubmit={handleSubscribe}>
                    ...
                    <Button
                      ...
                      disabled={subscribeStatus === 'loading'}
                    >
                      {subscribeStatus === 'loading' ? 'SubscribingGÇª' : 'Subscribe'}
                    </Button>
                  </form>
                </CardContent>
              </Card>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 md:p-10 shadow-sm">
          <div className="mx-auto flex max-w-4xl flex-col gap-10 md:flex-row">
            <div className="md:w-1/2 space-y-6">
              ...
              <form className="space-y-4" onSubmit={handleFeedbackSubmit}>
                ...
                <Button type="submit" className="w-full sm:w-auto" disabled={feedbackSubmitting}>
                  {feedbackSubmitting ? 'Sharing pizza loveGÇª' : 'Share feedback'}
                </Button>
              </form>
            </div>
            <div className="md:w-1/2 space-y-4">
              ...
              {feedbackLoading ? (
                <p className="text-sm text-slate-500">Loading pizza loveGÇª</p>
