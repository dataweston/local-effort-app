  ...
  return (
    <div className="mx-auto max-w-3xl px-4 md:px-6 lg:px-8 py-10">
      ...
      <ul className="space-y-4">
        {posts.map((p) => (
          <li key={p.slug} className="border rounded-lg p-4 hover:bg-gray-50 shadow-sm">
            <Link to={`/weekly/${p.slug}`} className="text-xl font-semibold hover:underline">{p.title}</Link>
