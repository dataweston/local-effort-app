...
2. **Financing facts:** local-only `local_effort_capital_master_record_v2_4.docx`, dated Sep. 16, 2026, regenerated by `scripts/update-capital-master-record-v2-4.ps1`. Request/mount it if it is not available. It supersedes older master-record versions and conversation summaries.
...
- Capital Master Record **v2.4** is canonical for cap table, founder compensation, founder-draw reconciliation, revenue history, facility economics, and diligence gaps.
- **Facility economics changed on 2026-09-15 (owner correction).** Foodist is the primary production and small-event facility from **2026-10-01 at a flat $1,800/month with unlimited included kitchen hours**; MSP Kitchenery (Hopkins) is now a **reserve** kitchen for overflow, larger events, and frozen-pizza CPG production, with an approximately **$350 September 2026 bill** and one to two months of transitional storage whose post-September cost is unresolved. The retired assumption is $25/hour plus $150 monthly fees and $200 monthly storage. Marginal facility cash cost per additional kitchen hour is now **zero** inside the included access, so modeled kitchen hours drive allocation rather than total facility spend.
