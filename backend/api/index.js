...
const { registerPartnerReviewRoutes } = require('./brain/partnerReviewRoutes');
const { registerOwnerInterviewRoutes } = require('./brain/ownerInterviewRoutes');
...
registerPartnerReviewRoutes(app, { logger });
registerOwnerInterviewRoutes(app, { logger });
