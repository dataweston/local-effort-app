    ...
    <>
      ...
      <div className="space-y-16 md:space-y-32">
        <section className="grid md:grid-cols-2 gap-8 items-center min-h-[60vh]">
            <div>
                <h2 className="text-hero uppercase">Minnesotan Food</h2>
                <h3 className="text-hero uppercase text-gray-400">For Your Functions.</h3>
                <p className="mt-8 text-body max-w-md">Professional in-home dining. 30 years collective fine food experience. Sourcing the best local ingredients without compromise.</p>
                <button onClick={() => navigate('/services')} className="btn btn-primary mt-8 text-lg">Explore Services</button>
            </div>
        ...
        <section>
            <h3 className="text-heading uppercase mb-8 border-b border-gray-900 pb-4">Core Offerings</h3>
