import{J as oe,a3 as ie,W as se,K as P,E as ae,D as g,L as ce,a4 as le,a5 as ue,a6 as F,n as he,_ as H,C as O,r as de}from"./index.esm-CSeNQ_sZ.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qe(e=oe(),t){e=ae(e);const r=P(e,"app-check");if(_().initialized||Me(),I()&&M().then(o=>console.log(`App Check debug token: ${o}. You will need to add it to your app's App Check settings in the Firebase console for it to work.`)),r.isInitialized()){const o=r.getImmediate(),i=r.getOptions();if(i.isTokenAutoRefreshEnabled===t.isTokenAutoRefreshEnabled&&i.provider.isEqual(t.provider))return o;throw u.create("already-initialized",{appName:e.name})}const n=r.initialize({options:t});return Xe(e,t.provider,t.isTokenAutoRefreshEnabled),c(e).isTokenAutoRefreshEnabled&&x(n,"INTERNAL",()=>{}),n}function Xe(e,t,r=!1){const n=pe(e,{...z});n.activated=!0,n.provider=t,n.cachedTokenPromise=Se(e).then(o=>(o&&p(o)&&(n.token=o,Y(e,{token:o.token})),o)),n.isTokenAutoRefreshEnabled=r&&e.automaticDataCollectionEnabled,!e.automaticDataCollectionEnabled&&r&&f.warn("`isTokenAutoRefreshEnabled` is true but `automaticDataCollectionEnabled` was set to false during `initializeApp()`. This blocks automatic token refresh."),n.provider.initialize(e)}function Ze(e,t){const r=e.app,n=c(r);n.tokenRefresher&&(t===!0?n.tokenRefresher.start():n.tokenRefresher.stop()),n.isTokenAutoRefreshEnabled=t}async function et(e,t){const r=await w(e,t);if(r.error)throw r.error;if(r.internalError)throw r.internalError;return{token:r.token}}function tt(e){return V(e)}function rt(e,t,r,n){let o=()=>{},i=()=>{};return t.next!=null?o=t.next.bind(t):o=t,t.error!=null?i=t.error.bind(t):r&&(i=r),x(e,"EXTERNAL",o,i),()=>N(e.app,o)}const Ve="app-check",L="app-check-internal";function Ye(){H(new O(Ve,e=>{const t=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat");return Oe(t,r)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider(L).initialize()})),H(new O(L,e=>{const t=e.getProvider("app-check").getImmediate();return Be(t)},"PUBLIC").setInstantiationMode("EXPLICIT")),de(Ke,Le)}Ye();export{te as CustomProvider,ee as ReCaptchaEnterpriseProvider,Z as ReCaptchaV3Provider,tt as getLimitedUseToken,et as getToken,Qe as initializeAppCheck,rt as onTokenChanged,Ze as setTokenAutoRefreshEnabled};
