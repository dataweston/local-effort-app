const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index.esm-D9XcD9Vk.js","assets/index-DcUdhh4B.js","assets/index-CMWrVfC_.css"])))=>i.map(i=>d[i]);
import{_ as vd}from"./index-DcUdhh4B.js";const Ad=()=>{};var Qa={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Je=new Ki("@firebase/app"),Sf="@firebase/app-compat",Pf="@firebase/analytics-compat",Cf="@firebase/analytics",bf="@firebase/app-check-compat",Vf="@firebase/app-check",kf="@firebase/auth",Df="@firebase/auth-compat",Nf="@firebase/database",Of="@firebase/data-connect",Mf="@firebase/database-compat",Lf="@firebase/functions",xf="@firebase/functions-compat",Ff="@firebase/installations",Uf="@firebase/installations-compat",Bf="@firebase/messaging",qf="@firebase/messaging-compat",jf="@firebase/performance",$f="@firebase/performance-compat",zf="@firebase/remote-config",Hf="@firebase/remote-config-compat",Gf="@firebase/storage",Wf="@firebase/storage-compat",Kf="@firebase/firestore",Qf="@firebase/ai",Yf="@firebase/firestore-compat",Jf="firebase",Xf="12.3.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Km{constructor(){this.changes=new Gt(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Ie.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?C.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
