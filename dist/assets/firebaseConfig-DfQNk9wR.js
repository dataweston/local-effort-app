...
import{_ as go}from"./index-CmPTWODQ.js";import{L as us,f,_ as tn,C as nn,r as yt,h as b,j as wn,k as re,m as Oe,n as It,p as mo,S as yo,t as Io,u as tt,v as Sn,w as W,x as Rn,D as An,y as xe,z as Eo,A as To,B as sn,E as kn,F as ds,G as F,H as vo,I as Lt,J as Co,K as wo,M as fs,N as Nn,O as So,P as Et,Q as Ro,R as nt,T as _s,U as ps,V as Ue,W as gs,X as Ao,Y as Pn,Z as U,$ as ko,a0 as bn,a1 as No,a2 as Po,a3 as bo,a4 as Oo,i as Do,g as Mo}from"./index.esm-BVcazjdI.js";var di={};const fi="@firebase/database",_i="1.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zt={},jt={};function Mn(n){const e=n.toString();return zt[e]||(zt[e]=new Zo),zt[e]}function ea(n,e){const t=n.toString();return jt[t]||(jt[t]=e()),jt[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new I(De,e),s=new I(De,t);return this.compare(i,s)!==0}minPost(){return I.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ys,Qs;function Ma(n){Ys=n}function La(n){Qs=n}class xa extends xt{compare(e,t){const i=e.node.getPriority(),s=t.node.getPriority(),r=i.compareTo(s);return r===0?Fe(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return I.MIN}maxPost(){return new I(ye,new k("[PRIORITY-POST]",Qs))}makePost(e,t){const i=Ys(e);return new I(t,new k("[PRIORITY-POST]",i))}toString(){return".priority"}}const D=new xa;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=D}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return f(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return f(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:De}hasEnd(){return this.endSet_}getIndexEndValue(){return f(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return f(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:ye}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return f(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===D}copy(){const e=new Fn;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function Pi(n){const e={};if(n.isDefault())return e;let t;if(n.index_===D?t="$priority":n.index_===Ga?t="$value":n.index_===ke?t="$key":(f(n.index_ instanceof Ha,"Unrecognized index type!"),t=n.index_.toString()),e.orderBy=b(t),n.startSet_){const i=n.startAfterSet_?"startAfter":"startAt";e[i]=b(n.indexStartValue_),n.startNameSet_&&(e[i]+=","+b(n.indexStartName_))}if(n.endSet_){const i=n.endBeforeSet_?"endBefore":"endAt";e[i]=b(n.indexEndValue_),n.endNameSet_&&(e[i]+=","+b(n.indexEndName_))}return n.limitSet_&&(n.isViewFromLeft()?e.limitToFirst=n.limit_:e.limitToLast=n.limit_),e}function bi(n){const e={};if(n.startSet_&&(e.sp=n.indexStartValue_,n.startNameSet_&&(e.sn=n.indexStartName_),e.sin=!n.startAfterSet_),n.endSet_&&(e.ep=n.indexEndValue_,n.endNameSet_&&(e.en=n.indexEndName_),e.ein=!n.endBeforeSet_),n.limitSet_){e.l=n.limit_;let t=n.viewFrom_;t===""&&(n.isViewFromLeft()?t="l":t="r"),e.vf=t}return n.index_!==D&&(e.i=n.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hi;function Nl(n){f(!Hi,"__referenceConstructor has already been defined"),Hi=n}class Bi{constructor(e){this.listenProvider_=e,this.syncPointTree_=new v(null),this.pendingWriteTree_=pl(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function dr(n,e,t,i,s){return sl(n.pendingWriteTree_,e,t,i,s),s?Ft(n,new Ie(Xs(),e,t)):[]}function ge(n,e,t=!1){const i=rl(n.pendingWriteTree_,e);if(ol(n.pendingWriteTree_,e)){let r=new v(null);return i.snap!=null?r=r.set(T(),!0):H(i.children,o=>{r=r.set(new w(o),!0)}),Ft(n,new Rt(i.path,r,t))}else return[]}function Ut(n,e,t){return Ft(n,new Ie(Zs(),e,t))}function Pl(n,e,t){const i=v.fromObject(t);return Ft(n,new Ze(Zs(),e,i))}function bl(n,e,t,i){const s=pr(n,i);if(s!=null){const r=gr(s),o=r.path,a=r.queryId,l=V(o,e),c=new Ie(er(a),l,t);return mr(n,o,c)}else return[]}function Ol(n,e,t,i){const s=pr(n,i);if(s){const r=gr(s),o=r.path,a=r.queryId,l=V(o,e),c=v.fromObject(t),h=new Ze(er(a),l,c);return mr(n,o,h)}else return[]}function qn(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=V(o,e),c=Gn(a,l);if(c)return c});return or(s,e,r,t,!0)}function Ft(n,e){return fr(e,n.syncPointTree_,null,sr(n.pendingWriteTree_,T()))}function fr(n,e,t,i){if(y(n.path))return _r(n,e,t,i);{const s=e.get(T());t==null&&s!=null&&(t=Gn(s,T()));let r=[];const o=m(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,h=lr(i,o);r=r.concat(fr(a,l,c,h))}return s&&(r=r.concat(Bn(s,n,i,t))),r}}function _r(n,e,t,i){const s=e.get(T());t==null&&s!=null&&(t=Gn(s,T()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=lr(i,o),h=n.operationForChild(o);h&&(r=r.concat(_r(h,a,l,c)))}),s&&(r=r.concat(Bn(s,n,i,t))),r}function pr(n,e){return n.tagToQueryMap.get(e)}function gr(n){const e=n.indexOf("$");return f(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new w(n.substr(0,e))}}function mr(n,e,t){const i=n.syncPointTree_.get(e);f(i,"Missing sync point for query tag that we're tracking");const s=sr(n.pendingWriteTree_,e);return Bn(i,t,s,null)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mh(n,e={}){return He(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
