...
const plans = {
  ...
  gabriella: {
    ...
    maxTotalItems: 5,
    allowDuplicates: true,
    billing: { monthlyTotalCents: 140500, equivalentWeeklyCents: 35125, cadence: 'every_4_weeks', billingDay: 'every 4 weeks', nextBillingDate: '2026-08-31' },
  },
  david: {
    schemaVersion: 2,
    sections: {
    ...
    billing: { monthlyTotalCents: 106800, equivalentWeeklyCents: 26700, cadence: 'every_4_weeks', billingDay: 'every 4 weeks', nextBillingDate: '2026-09-10' },
  },
  catherine: {
    schemaVersion: 2,
    sections: {
...
const plannerUpdates = [
  ...
  },
  {
    ...
    weeklyCents: 35125,
    enabled: true,
    source: 'Owner-confirmed $1,405 billing every four weeks; the $1,060 invoice paid August 3 credited one skipped service week',
    metadata: { billingCustomerName: 'Gabriella Scarpa', billingAmountCents: 140500, billingCadence: 'every_4_weeks', nextBillingDate: '2026-08-31', billingStatus: 'active', squareRecipient: 'scarpa.gabriella5@gmail.com', serviceDay: 'Tuesday', currentMonthSkippedWeeks: 1 },
    notes: 'Billing is $1,405 every four weeks. The August 3 invoice was $1,060 because it credited one skipped service week; next billing is August 31.',
  },
  {
    ...
    weeklyCents: 26700,
    enabled: true,
    source: 'Square invoice 000013-R-0012 scheduled for $1,068 on September 10; owner identified September 10 billing on a four-week cycle',
    metadata: { billingCustomerName: 'David and Allison', billingAmountCents: 106800, billingCadence: 'every_4_weeks', nextBillingDate: '2026-09-10', billingStatus: 'active', squareRecipient: 'davelevy3@gmail.com', serviceDay: 'Monday' },
    notes: 'Billing is $1,068 every four weeks. Square invoice #000013-R-0012 is scheduled for September 10.',
  },
  {
