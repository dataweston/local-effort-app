...
CREATE TABLE IF NOT EXISTS calendar_events (
  ...
  start_time TIME,
  end_time TIME,
  event_type TEXT CHECK (event_type IN ('pizza_party', 'meal_prep', 'catering', 'private_event', 'blocked', 'other')) DEFAULT 'other',
  visibility TEXT CHECK (visibility IN ('public', 'private', 'internal')) DEFAULT 'private',
  status TEXT CHECK (status IN ('draft', 'scheduled', 'confirmed', 'completed', 'cancelled')) DEFAULT 'scheduled',
  location TEXT,
